...
This folder contains the hardware documentation, circuit diagrams and simulation files for a Smart AC Dimmer project. The project explores the transition from a traditional analog AC dimmer to an intelligent, microcontroller-driven dimmer system. 
...
*   **YouTube Community** – Special thanks to the creators covering various topics i.e
    - triac drivers *https://youtu.be/kRrBL9sri10?si=ig0juJTxHIhvTWyB* 
    - analog ac dimmer *https://youtu.be/jS9ANqJf-ZY?si=BGliZ3KXmKWGh3t8* 
     - simulating an ac dimmer *https://youtu.be/RvjNL4PzcWk?si=tl9ha6qjE5_5elTJ*